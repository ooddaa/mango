  ...
  findNode(labels, props) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      var pnode = _this2.builder.buildPartialNodes([{
        labels,
        properties: _objectSpread({}, _this2._buildSearchedProps(props))
      }]);
      /* check if succeeded */
  ...
  buildAndMergeEnhancedNode(graphPattern) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      var {
        ...
        optionalProps,
        privateProps
      } = _this7.decomposeProps(graphPattern.properties);

      var enode = _this7.builder.makeEnhancedNode(_this7.builder.makeNode(graphPattern.labels, requiredProps, _objectSpread(_objectSpread({}, optionalProps), privateProps)), [...graphPattern.relationships.map(relObject => {
        var {
          requiredProps,
          optionalProps,
          privateProps
        } = _this7.decomposeProps(relObject.partnerNode.properties);

        return _this7.builder.makeRelationshipCandidate(relObject.labels, _this7.builder.makeNode(relObject.partnerNode.labels, requiredProps, _objectSpread(_objectSpread({}, optionalProps), privateProps)));
      })]);
  ...
  deleteNode(node) {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      if (config.archiveNodes) {
        ...
        var results = yield _this8.engine.deleteNodes([node], {
