...
function isSimplifiedNode(obj) {
  ...
  var conditions = {
    ...
    noRelationships: // at least conform to standard, although empty

    /* no relationships whatsoever */
    (0, _utils.isMissing)(relationships) ||
    /* or relationships is not object */
    (0, _lodash.isObject)(relationships) &&
    /* or object has no inbound/outbound props */
    (0, _lodash.has)(relationships, 'inbound') && (0, _lodash.has)(relationships, 'outbound') &&
    /* or inbound/outbound aren't Arrays */
    (0, _lodash.isArray)(relationships.inbound) && (0, _lodash.isArray)(relationships.outbound) &&
